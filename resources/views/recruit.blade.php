...
@section('content')
    ...
    <div class="relative py-4 md:py-24 bg-cover bg-top bg-no-repeat"
        ...
        <div class="container md:w-[70%] mx-auto p-4 py-12">
            {{-- Add the content for your recruitment page here --}}
            <div class="mt-8 py-6 px-4 " style="background-color: #faf4dd">
                <h2 class="text-2xl md:text-4xl text-center text-orange-400 mb-6">募集情報</h2>

                <div x-data="{ activeTab: 1 }" class="max-w-2xl md:mx-auto mx-2 text-white">
                    {{-- タブタイトル部分 --}}
